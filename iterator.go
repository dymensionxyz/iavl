...
// 1. It has length of 0, meaning that there are no more traversable nodes.
...
// NewIterator returns a new iterator over the immutable tree. If the tree is nil, the iterator will be invalid.
